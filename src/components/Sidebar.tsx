        ...
        <>
            {
                ...
                <div className={`w-[300px] p-5 bg-[#F8F9F8] fixed top-0 left-0 h-[1000px] hidden max-[1200px]:inline-block shadow-lg`}>
                    ...
                    <div className="bg-[#4FD1C5] p-4 text-white rounded-2xl">
                        ...
                        <h3 className="my-2 mt-5 font-semibold">New Assignment?</h3>
                        <p className="text-white/70 text-sm line-clamp-2">Select from pre-defined questions to have a quick turnaround.</p>
                        <button className="mt-3 bg-white text-[#303A4B] text-sm  w-full p-2 rounded-lg font-semibold">Create New Assignment</button>
                    </div>
                </div>
            }
